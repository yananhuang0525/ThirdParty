...
import com.panku.thirdparty.mzBanner.transformer.CoverModeTransformer;
import com.panku.thirdparty.mzBanner.transformer.ScaleYTransformer;
...
public class MZBannerView<T> extends RelativeLayout {
    ...
    private MZBannerView.MZPagerAdapter mAdapter;
    ...
    private MZBannerView.ViewPagerScroller mViewPagerScroller;//控制ViewPager滑动速度的Scroller
    ...
    private int[] mIndicatorRes = new int[]{R.drawable.bg_home_dot_default, R.drawable.bg_home_dot};
    ...
    private int mIndicatorLocation = 0;//indicator位置
    ...
    private void readAttrs(Context context, AttributeSet attrs) {
        ...
        mIndicatorAlign = typedArray.getInt(R.styleable.MZBannerView_indicatorAlign, MZBannerView.IndicatorAlign.CENTER.ordinal());
        mIndicatorLocation = typedArray.getInt(R.styleable.MZBannerView_indicatorLocation, IndicatorLocation.INSIDE.ordinal());
    ...
    private void init() {
        View view = null;
        if (mIndicatorLocation == IndicatorLocation.OUTSIDE.ordinal()) {
            if (mIsOpenMZEffect) {
                view = LayoutInflater.from(getContext()).inflate(R.layout.mz_banner_effect_layout_outside, this, true);
            } else {
                view = LayoutInflater.from(getContext()).inflate(R.layout.mz_banner_normal_layout_outside, this, true);
            }
        } else {
            if (mIsOpenMZEffect) {
                view = LayoutInflater.from(getContext()).inflate(R.layout.mz_banner_effect_layout_inside, this, true);
            } else {
                view = LayoutInflater.from(getContext()).inflate(R.layout.mz_banner_normal_layout_inside, this, true);
            }
        }
    ...
    private void sureIndicatorPosition() {
        if (mIndicatorAlign == MZBannerView.IndicatorAlign.LEFT.ordinal()) {
            setIndicatorAlign(MZBannerView.IndicatorAlign.LEFT);
        } else if (mIndicatorAlign == MZBannerView.IndicatorAlign.CENTER.ordinal()) {
    ...
    private void initViewPagerScroll() {
        try {
            ...
            mViewPagerScroller = new MZBannerView.ViewPagerScroller(
    ...
    private void initIndicator() {
        ...
        for (int i = 0; i < mDatas.size(); i++) {
            ...
            if (mIndicatorAlign == MZBannerView.IndicatorAlign.LEFT.ordinal()) {
            ...
            } else if (mIndicatorAlign == MZBannerView.IndicatorAlign.RIGHT.ordinal()) {
                if (i == mDatas.size() - 1) {
                ...
                imageView.setPadding(6 + mIndicatorPaddingLeft, 0 + mIndicatorPaddingTop, 6 + mIndicatorPaddingBottom, 0 + mIndicatorPaddingBottom);
            }
     ...
     * 添加Page点击事件
     *
     * @param bannerPageClickListener {@link MZBannerView.BannerPageClickListener}
     */
    public void setBannerPageClickListener(MZBannerView.BannerPageClickListener bannerPageClickListener) {
    ...
    public void setIndicatorPadding(int paddingLeft, int paddingTop, int paddingRight, int paddingBottom) {
        mIndicatorPaddingLeft = dpToPx(paddingLeft);
        mIndicatorPaddingTop = dpToPx(paddingTop);
        mIndicatorPaddingRight = dpToPx(paddingRight);
        mIndicatorPaddingBottom = dpToPx(paddingBottom);
        sureIndicatorPosition();
    }
    ...
    public void setPages(List<T> datas, MZHolderCreator mzHolderCreator) {
        ...
        mAdapter = new MZBannerView.MZPagerAdapter(datas, mzHolderCreator, mIsCanLoop);
     ...
     * 设置Indicator 的对齐方式
     *
     * @param indicatorAlign {@link MZBannerView.IndicatorAlign#CENTER }{@link MZBannerView.IndicatorAlign#LEFT }{@link MZBannerView.IndicatorAlign#RIGHT }
     */
    ...
    public static class MZPagerAdapter<T> extends PagerAdapter {
        ...
        private MZBannerView.BannerPageClickListener mPageClickListener;
        ...
        public void setPageClickListener(MZBannerView.BannerPageClickListener pageClickListener) {
